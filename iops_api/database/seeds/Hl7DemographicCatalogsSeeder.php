...
class Hl7DemographicCatalogsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $this->command->info('Iniciando carga de Catálogos Demográficos Faltantes...');

        $files = [
            'fhir_rethus_qualification' => 'CodeSystem-RETHUSqualification.json'
        ];
