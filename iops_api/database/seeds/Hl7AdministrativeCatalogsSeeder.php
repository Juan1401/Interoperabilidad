...
class Hl7AdministrativeCatalogsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $this->command->info('Iniciando carga de Catálogos Administrativos...');

        $files = [
            'fhir_via_ingreso' => 'CodeSystem-ViaIngreso.json',
            'fhir_entorno_atencion' => 'CodeSystem-EntornoAtencion.json',
            'fhir_rips_causa_externa' => 'CodeSystem-RIPSCausaExternaVersion2.json',
            'fhir_rips_finalidad_consulta' => 'CodeSystem-RIPSFinalidadConsultaVersion2.json'
        ];
