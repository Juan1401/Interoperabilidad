...
export class ConsultarIhceService {
  ...
  consultarRecurso(resourcePath: string): Observable<any> {
    ...
    return this.http.post<any>(`${this.apiUrl}/consulta-ministerio/recurso`, { resource_path: path }, {
      headers: this.getAuthHeaders().set('Content-Type', 'application/json')
    });
  }
  ...
  consultarDocumentoExterno(url: string): Observable<DocumentoExternoResponse> {
    ...
    return this.http.post<DocumentoExternoResponse>(
      `${this.apiUrl}/consulta-ministerio/documento-externo`,
      payload,
      { headers: this.getAuthHeaders().set('Content-Type', 'application/json') }
    );
  }
  ...
  registrarAuditoriaRda(payload: RdaAuditPayload): void {
    ...
    this.http.post<any>(
      `${this.apiUrl}/consulta-ministerio/audit/rda-view`,
      payload,
      { headers: this.getAuthHeaders().set('Content-Type', 'application/json') }
    ).subscribe({
