...
import { ProcedimientoData, parseFhirProcedure } from '../rda-urgencias/modal-rda-urgencias.utils';

// Códigos LOINC de las secciones de la Composition de Hospitalización
...
@Component({
    selector: 'app-modal-rda-hospitalizacion',
    standalone: true,
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [CommonModule, DatePipe, SafeDatePipe, TitleCasePipe, ButtonModule, TooltipModule, PdfViewerModule],
    templateUrl: './modal-rda-hospitalizacion.html',
    styleUrl: './modal-rda-hospitalizacion.scss'
})
export class ModalRdaHospitalizacionComponent implements OnInit {
