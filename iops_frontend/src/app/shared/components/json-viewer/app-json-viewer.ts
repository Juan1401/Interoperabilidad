...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, AccordionModule, TagModule, BadgeModule],
                    ...
                    <p-accordion-panel [value]="key">
                        <p-accordion-header>
                            ...
                            @if (isArray(getValue(data, key))) {
                                <p-badge [value]="getValue(data, key).length" severity="secondary" styleClass="jv-badge"> </p-badge>
                            }
                            ...
                            @if (!isComplexType(getValue(data, key)) && getValue(data, key) !== null) {
                                <span class="jv-inline-value ml-2" [class]="getPrimitiveClass(getValue(data, key))"> → {{ formatPrimitive(getValue(data, key)) }} </span>
                            }
    ...
    styles: [
        `
            ...
            :host ::ng-deep .jv-accordion .p-accordionheader {
                padding: 0.4rem 0.75rem;
            }
            :host ::ng-deep .jv-accordion .p-accordioncontent-content {
                padding: 0.4rem 0.5rem;
            }
            :host ::ng-deep .jv-accordion .p-accordionpanel {
